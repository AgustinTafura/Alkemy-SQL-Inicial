...
SELECT p.nombre, p.apellido, p.`fecha de nacimiento` FROM profesor p ORDER BY p.`fecha de nacimiento` ASC;
...
SELECT * FROM profesor WHERE `fecha de nacimiento` BETWEEN "1980-01-01" AND "1989-12-31";
...
SELECT * FROM profesor WHERE `fecha de nacimiento` BETWEEN "1980-01-01" AND "1989-12-31" AND salario > 80000;